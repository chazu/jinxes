...
class RemoteEventDispatch:
    ...
    def emit_message(self, channel, frame, method, body):
        self.app.remote_messages.append(json.loads(body))

    def init_consume(self):
        self.channel.basic_consume(self.emit_message, self.exclusive_queue_id, no_ack=True)
